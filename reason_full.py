...
def evaluate_answer(question, ground_truth_answer, predicted_answer, token_monitor=None):
    """
    ...
    Args:
        ...
        token_monitor: Optional TokenMonitor to track token usage
    ...
    try:
        response = generate_text_response(prompt, token_monitor=token_monitor)
