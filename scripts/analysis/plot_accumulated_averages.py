...
def main() -> None:
    ...
    parser.add_argument(
        "--output-plot",
        default="data/analysis/avg_accumulated_metrics_by_clip.png",
        help="Output PNG path.",
    )
    parser.add_argument(
        "--output-json",
        default="data/analysis/avg_accumulated_metrics_by_clip.json",
        help="Output JSON path for averaged values.",
    )
    parser.add_argument(
        "--output-csv",
        default="data/analysis/avg_accumulated_metrics_by_clip.csv",
